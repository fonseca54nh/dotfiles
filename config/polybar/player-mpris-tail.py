...
class Player:
    ...
    def printStatus(self):
        if self.status in [ 'playing', 'paused' ]:
            ...
            try:
                text = re.sub(r'\U0010ffffp\U0010ffff(.*?)\U0010ffffp\U0010ffff(.*?)\U0010ffffp\U0010ffff(.*?)\U0010ffffp\U0010ffff', r'%{\1}\2%{\3}', text.format_map(CleanSafeDict(**metadata)))
            except:
...
FORMAT_STRING = re.sub(r'%\{(.*?)\}(.*?)%\{(.*?)\}', r'\U0010ffffp\U0010ffff\1\U0010ffffp\U0010ffff\2\U0010ffffp\U0010ffff\3\U0010ffffp\U0010ffff', args.format)
